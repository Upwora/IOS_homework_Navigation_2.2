...
class LogInViewController: UIViewController {
    ...
    func layout(){
        ...
        errorLabel.centerXAnchor.constraint(equalTo: passTextField.centerXAnchor).isActive = true
        errorLabel.bottomAnchor.constraint(equalTo: button.topAnchor, constant: -16).isActive = true
        
        button.topAnchor.constraint(equalTo: errorLabel.bottomAnchor, constant: 16).isActive = true
...
//            
//        } else {
//            if emailTextField.text == "your@mail.com" && passTextField.text == "1234567" {
